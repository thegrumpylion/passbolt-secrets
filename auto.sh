...
kubectl create -f kube/db/namespace.yaml
...
kubectl create -f kube/db/pod.yaml

kubectl create -f kube/db/service.yaml

# PASSBOLT

kubectl create -f kube/passbolt/namespace.yaml
...
kubectl create -f kube/passbolt/pod.yaml

kubectl create -f kube/passbolt/service.yaml
